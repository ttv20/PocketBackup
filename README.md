...
```text
POCKETBACKUP_RELEASE_STORE_FILE
POCKETBACKUP_RELEASE_STORE_PASSWORD
POCKETBACKUP_RELEASE_KEY_ALIAS
POCKETBACKUP_RELEASE_KEY_PASSWORD
...
```text
POCKETBACKUP_RELEASE_KEYSTORE_B64
POCKETBACKUP_RELEASE_STORE_PASSWORD
POCKETBACKUP_RELEASE_KEY_ALIAS
POCKETBACKUP_RELEASE_KEY_PASSWORD
```
