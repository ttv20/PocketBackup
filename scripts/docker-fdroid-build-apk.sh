...
: "${POCKETBACKUP_OFFICIAL_DIAGNOSTICS_ENABLED:=true}"
: "${POCKETBACKUP_DIAGNOSTICS_USER_OPT_IN_REQUIRED:=true}"
export POCKETBACKUP_OFFICIAL_DIAGNOSTICS_ENABLED
export POCKETBACKUP_DIAGNOSTICS_USER_OPT_IN_REQUIRED

for env_name in \
  POCKETBACKUP_VERSION_CODE \
  POCKETBACKUP_VERSION_NAME \
  POCKETBACKUP_OFFICIAL_DIAGNOSTICS_ENABLED \
  POCKETBACKUP_DIAGNOSTICS_USER_OPT_IN_REQUIRED \
  POCKETBACKUP_MEASURE_BUILD_UPLOAD_ENABLED \
  MEASURE_API_KEY \
  MEASURE_API_URL \
  DIAGNOSTICS_PROXY_URL \
